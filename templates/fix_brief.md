...
3. If it is a feature request, a wish, or a redesign, do not implement it. Reject it, and say in the note that it belongs on the wish list, which his person fills with wishes earned from levels and luck.
...
A rejection is a fine outcome. The person reads the log page.
