...
- Every 5 levels he gets a thing. Every 3 levels he gets a talent point. Levels come slowly: two months of work is about level 10.
...
| `w` | wishes: things you would like. Every forge run reads them for inspiration |
| `l` | log: what happened |
| `i` | info |
